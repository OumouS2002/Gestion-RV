...
require_once CONTROLLER.'editePlan.php'; //inclure le fichier ajout du nouvel Planing
...
<div class="container">
    ...
    <fieldset class="panel panel-info form-horizontal">
		<div class="panel-heading">Modifier le  Planing </div>
...
<input type="time" name="heureDeb" id="heureDeb" class="form-control"  value="<?php echo $ModifPlan->heureDeb; ?>" required> 
<small> <b class="color-red"> <?php if(!empty($error['heuredeb'])) echo $error['heuredeb']?> </b>
</div></div>
<div class="form-group">
		<div class="col-lg-12">
  <label for="heureFin">Heure Fin Planning</label>
  <input type="time" name="heureFin" id="heureFin" class="form-control" value="<?php echo $ModifPlan->heureFin; ?>" required>		
...
<div class="form-group">
  ...
  <input type="date" name="datePlan" id="datePlan" class="form-control" value="<?php echo $ModifPlan->datePlan; ?>" required> 		
</div></div>
